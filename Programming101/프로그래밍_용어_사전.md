...
57.  `OpenStack`
     ...
     - OpenStack 의 구성   [(출처)]([https://velog.io/@dojun527/%EC%98%A4%ED%94%88-%EC%8A%A4%ED%83%9D%EC%9D%B4%EB%9E%80](https://velog.io/@dojun527/오픈-스택이란))
...
58.  `Hypervisor`
     ...
     - Host computer 에서 다수의 운영 체제를 동시에 실행하기 위한 논리적 platform
       - virtual machine manager (VMM) 라고도 부르다
